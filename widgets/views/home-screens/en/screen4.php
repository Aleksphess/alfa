                ...
                <div class="screen__promo">
                        <div class="promo__block-1">
                                <div class="promo__title promo__title-1">
                                        <div data-anijs="if: scroll, on: window, do: slideInUp animated, before: scrollReveal, after: holdAnimClass" class="is-animated">Теперь запуск вашего бизнеса будет ощутимо</div>
                                </div>
                        ...
                        <div class="promo__block-2">
                                <div class="promo__title promo__title-2">
                                        <div data-anijs="if: scroll, on: window, do: slideInUp animated, before: scrollReveal, after: holdAnimClass" class="is-animated">Кому мы полезны ?</div>
                                </div>
